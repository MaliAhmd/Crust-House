...
@section('main')
    ...
    <main id="settings">
        ...
        <div id="options">
            ...
            <button onclick="showThemeSetting()">Theme Settings</button>
            ...
            @if ($profile)
                <form action="{{ route('updateProfile') }}" class="updateProfile" id="updateProfile" method="POST" enctype="multipart/form-data">
                    @csrf
                    <h3>Edit Profile</h3>
                    <hr>
