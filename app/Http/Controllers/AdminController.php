...
class AdminController extends Controller
{
    ...
    */
    ...
    public function viewStockPage($id, $branch_id)
    {
        ...
        return view('Admin.Stock')->with(['stockData' => $stocks, 'notification' => $notifications, 'user_id' => $id, 'branch_id' => $branch_id]);
    }
    ...
    public function showCategoryProducts($category_id, $branch_id, $user_id)
    {
        ...
        return view('Admin.Recipe')->with(['categoryProducts' => $categoryProducts, 'categories' => $categories, 'branch_id' => $branch_id, 'user_id' => $user_id, 'stocks' => $stocks, 'recipes' => $recipes]);
    }
    ...
    public function tillReconcilationFigureByDate(Request $request)
    {
        ...
        foreach ($dailyOrders as $order) {
            ...
            if ($order->status == 1) {
                ...
                $dailyReconciliation['sales_data'][$salesmanName][$order_date]['discount'] += $order_bill;
            }
        }
        if ($dailyOrders->isEmpty()) {
